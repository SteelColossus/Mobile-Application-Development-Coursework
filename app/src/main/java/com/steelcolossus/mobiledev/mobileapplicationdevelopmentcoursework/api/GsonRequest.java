...
/**
 * Taken from the VolleyPlus library.
...
public class GsonRequest<T> extends Request<T>
{
     ...
     * @param headers Map of request headers
     */
    public GsonRequest(int type, String url, Class<T> clazz, Map<String, String> headers, Map<String, String> params, Response.Listener<T> listener, Response.ErrorListener errorListener)
    {
