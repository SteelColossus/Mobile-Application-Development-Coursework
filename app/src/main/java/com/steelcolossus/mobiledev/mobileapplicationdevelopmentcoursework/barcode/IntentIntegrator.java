...
package com.steelcolossus.mobiledev.mobileapplicationdevelopmentcoursework.barcode;
...
public class IntentIntegrator
{
    ...
    public static final List<String> TARGET_ALL_KNOWN = list(BSPLUS_PACKAGE,             // Barcode Scanner+
